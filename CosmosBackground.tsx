...
/**
 * User progress stats from memory
 */
interface UserStats {
  projects: number;
  lessons: number;
...
/**
 * Dashboard preferences for tile visibility
 */
...
/**
 * Dashboard - A bento grid of interactive tiles for the sidebar
 * Features customization, stats from memory, and smooth animations
 */
export default function Dashboard({ isOpen, onClose, onNavigate }: DashboardProps) {
  ...
  /**
   * Load stats and preferences from memory on mount
   */
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        // Use defaults if memory unavailable
      }
    };
  ...
  /**
   * Handle tile click - navigate or trigger action
   */
  ...
  /**
   * Toggle tile visibility in customization modal
   */
      ...
      >
        <div className="h-full w-80 glass-panel border-r border-glass-border flex flex-col">
              ...
              {visibleTiles.map((tile, index) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: `radial-gradient(circle at 50% 50%, ${tile.glow}, transparent 70%)`,
                    }}
                  />
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="font-display font-semibold text-sm text-starlight mb-1">
                      {tile.title}
                    </h3>
          ...
          <div className="p-4 border-t border-glass-border">
            <p className="text-center text-xs text-starlight/30">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          <div className="glass-panel w-full max-w-md relative z-10 p-6 animate-scale-in">
            ...
            <p className="text-sm text-starlight/60 mb-4">
              Select which tiles to display on your dashboard:
            </p>
