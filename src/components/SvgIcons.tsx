...
/**
 * Creates a base SVG wrapper with common attributes
 */
const createIcon = (
...
/**
 * Star icon - used for favorites and cosmic elements
 */
...
/**
 * Heart icon - used for the dashboard toggle and love elements
 */
...
/**
 * Code icon - used for workspace navigation
 */
...
/**
 * Chat icon - used for chat navigation
 */
...
/**
 * Settings icon - used for configuration
 */
...
/**
 * Close icon - used for modals and dismissals
 */
...
/**
 * Copy icon - used for copying code
 */
...
/**
 * Download icon - used for downloading files
 */
...
/**
 * Run/Play icon - used for executing code
 */
...
/**
 * Refresh icon - used for reloading
 */
...
/**
 * External link icon - used for opening in new tab
 */
...
/**
 * Paperclip icon - used for file attachments
 */
...
/**
 * Send icon - used for sending messages
 */
...
/**
 * Microphone icon - used for voice input
 */
...
/**
 * File icon - used for file management
 */
...
/**
 * Calendar icon - used for scheduling
 */
...
/**
 * Constellation icon - used for universe navigation
 */
...
/**
 * Dove/Bird icon - used for peace and love elements
 */
export const DoveIcon = ({ size = 24, className = "" }: IconProps) =>
  createIcon(
    <>
      <path d="M12 2C8 2 5 5 5 9c0 3 2 5 4 7l3 6 3-6c2-2 4-4 4-7 0-4-3-7-7-7z" />
...
/**
 * Sparkles icon - used for magic and AI effects
 */
...
/**
 * Home icon - used for dashboard navigation
 */
...
/**
 * Plane icon - used for travel and exploration
 */
...
/**
 * Building icon - used for cities and locations
 */
...
/**
 * Map pin icon - used for location markers
 */
...
/**
 * Car icon - used for transportation
 */
export const CarIcon = ({ size = 24, className = "" }: IconProps) =>
  createIcon(
    <>
      <path d="M14 16H9m10 0h3v-3.15a1 1 0 0 0-.84-.99L16 11l-2.7-5.25a1 1 0 0 0-.9-.55H8.5a1 1 0 0 0-.9.55L5 11l-3.16.86a1 1 0 0 0-.84.99V16h3m10 0h-5" />
...
/**
 * Baby icon - used for nurturing and care
 */
export const BabyIcon = ({ size = 24, className = "" }: IconProps) =>
  createIcon(
    <>
      ...
      <path d="M19 6.3a9 9 0 0 1 1.8 3.9 2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3 1.33 5 3.3z" />
    </>,
    { size, className }
  );

/**
 * Menu/Hamburger icon - used for mobile navigation
 */
...
/**
 * Check icon - used for confirmations
 */
...
/**
 * Moon icon - used for night mode and cosmic themes
 */
...
/**
 * Palette icon - used for theme picker
 */
...
/**
 * Eye icon - used for visibility toggle
 */
...
/**
 * Eye off icon - used for hiding content
 */
...
/**
 * Zap icon - used for energy/power indicators
 */
...
/**
 * Globe icon - used for the universe/earth view
 */
...
/**
 * Layout icon - used for workspace layout switching
 */
...
/**
 * Split icon - used for split view
 */
...
/**
 * Maximize icon - used for fullscreen
 */
...
/**
 * Minimize icon - used for minimizing
 */
...
/**
 * Chevron down icon - used for dropdowns
 */
