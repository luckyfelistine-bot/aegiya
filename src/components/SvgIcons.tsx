...
// Extend standard SVG props so that any prop (style, onClick, etc.) can be passed
interface IconProps extends React.SVGProps<SVGSVGElement> {
  size?: number;
}

/**
 * Helper to create an SVG icon with common attributes.
 * All additional props (style, className, onClick) are spread to the <svg> element.
 */
const createIcon = (
...
export const StarIcon = (props: IconProps) =>
  createIcon(<polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />, props);
...
export const SettingsIcon = (props: IconProps) =>
  createIcon(<><circle cx="12" cy="12" r="3" /><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1 0 2.83 2 2 0 0 1-2.83 0l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-2 2 2 2 0 0 1-2-2v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83 0 2 2 0 0 1 0-2.83l.06-.06A1.65 1.65 0 0 0 4.6 15a1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1-2-2 2 2 0 0 1 2-2h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 0-2.83 2 2 0 0 1 2.83 0l.06.06A1.65 1.65 0 0 0 9 4.6a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 2-2 2 2 0 0 1 2 2v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 0 2 2 0 0 1 0 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 2 2 2 2 0 0 1-2 2h-.09a1.65 1.65 0 0 0-1.51 1z" /></>, props);
...
export const RefreshIcon = (props: IconProps) =>
  createIcon(<><polyline points="23 4 23 10 17 10" /><polyline points="1 20 1 14 7 14" /><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15" /></>, props);
...
export const ConstellationIcon = (props: IconProps) =>
  createIcon(<><circle cx="12" cy="12" r="1" /><circle cx="18" cy="6" r="1" /><circle cx="6" cy="18" r="1" /><circle cx="6" cy="6" r="1" /><circle cx="18" cy="18" r="1" /><line x1="12" y1="12" x2="18" y2="6" /><line x1="12" y1="12" x2="6" y2="18" /><line x1="12" y1="12" x2="6" y2="6" /><line x1="12" y1="12" x2="18" y2="18" /><line x1="6" y1="6" x2="18" y2="6" /><line x1="6" y1="18" x2="18" y2="18" /></>, props);

export const DoveIcon = (props: IconProps) =>
  createIcon(<><path d="M12 2C8 2 5 5 5 9c0 3 2 5 4 7l3 6 3-6c2-2 4-4 4-7 0-4-3-7-7-7z" /><path d="M12 9a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" /></>, props);

export const SparklesIcon = (props: IconProps) =>
  createIcon(<><path d="M12 3L14.5 8.5L20 11L14.5 13.5L12 19L9.5 13.5L4 11L9.5 8.5L12 3Z" /><path d="M5 3L6 5L8 6L6 7L5 9L4 7L2 6L4 5L5 3Z" /><path d="M19 15L20 17L22 18L20 19L19 21L18 19L16 18L18 17L19 15Z" /></>, props);
...
export const PlaneIcon = (props: IconProps) =>
  createIcon(<><path d="M22 2L11 13" /><polygon points="22 2 15 22 11 13 2 9 22 2" /></>, props);

export const BuildingIcon = (props: IconProps) =>
  createIcon(<><rect x="4" y="2" width="16" height="20" rx="2" ry="2" /><line x1="9" y1="22" x2="9" y2="2" /><line x1="15" y1="22" x2="15" y2="2" /><line x1="9" y1="12" x2="15" y2="12" /><line x1="9" y1="7" x2="15" y2="7" /><line x1="9" y1="17" x2="15" y2="17" /></>, props);
...
export const CarIcon = (props: IconProps) =>
  createIcon(<><path d="M14 16H9m10 0h3v-3.15a1 1 0 0 0-.84-.99L16 11l-2.7-5.25a1 1 0 0 0-.9-.55H8.5a1 1 0 0 0-.9.55L5 11l-3.16.86a1 1 0 0 0-.84.99V16h3m10 0h-5" /><circle cx="6.5" cy="16.5" r="2.5" /><circle cx="17.5" cy="16.5" r="2.5" /></>, props);

export const BabyIcon = (props: IconProps) =>
  createIcon(<><path d="M9 12h.01" /><path d="M15 12h.01" /><path d="M10 16c.5.3 1.2.5 2 .5s1.5-.2 2-.5" /><path d="M19 6.3a9 9 0 0 1 1.8 3.9 2 2 0 0 1 0 3.6 9 9 0 0 1-17.6 0 2 2 0 0 1 0-3.6A9 9 0 0 1 12 3c2 0 3 1.33 5 3.3z" /></>, props);
...
export const ErrorIcon = (props: IconProps) =>
  createIcon(<><circle cx="12" cy="12" r="10" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="16" x2="12.01" y2="16" /><line x1="8" y1="8" x2="16" y2="16" /></>, props);
...
export const PaletteIcon = (props: IconProps) =>
  createIcon(<><circle cx="13.5" cy="6.5" r=".5" fill="currentColor" /><circle cx="17.5" cy="10.5" r=".5" fill="currentColor" /><circle cx="8.5" cy="7.5" r=".5" fill="currentColor" /><circle cx="6.5" cy="12.5" r=".5" fill="currentColor" /><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.01 17.461 2 12 2z" /></>, props);

export const TrashIcon = (props: IconProps) =>
  createIcon(<><polyline points="3 6 5 6 21 6" /><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2" /><line x1="10" y1="11" x2="10" y2="17" /><line x1="14" y1="11" x2="14" y2="17" /></>, props);
...
export const SplitIcon = (props: IconProps) =>
  createIcon(<><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /><line x1="12" y1="3" x2="12" y2="21" /></>, props);
...
export const MinimizeIcon = (props: IconProps) =>
  createIcon(<><path d="M8 3v3a2 2 0 0 1-2 2H3m18 0h-3a2 2 0 0 1-2-2V3m0 18v-3a2 2 0 0 1 2-2h3M3 16h3a2 2 0 0 1 2 2v3" /></>, props);

export const ChevronRightIcon = (props: IconProps) =>
  createIcon(<polyline points="9 18 15 12 9 6" />, props);

export const ArrowRightIcon = ChevronRightIcon; // alias
